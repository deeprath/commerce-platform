// Command seller serves SellerService — the marketplace shop aggregate and its
// onboarding lifecycle. It relays commerce.shop.* via the transactional outbox.
package main
